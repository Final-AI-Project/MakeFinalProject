...
# python models/classifier/train_classifier.py --data_root models/plants-dataset --model efficientnet_b0 --epochs 10 --weighted_sampler
# python models/classifier/train_classifier.py --data_root models/plants-dataset --model mobilenet_v3_large --epochs 10 --weighted_sampler
