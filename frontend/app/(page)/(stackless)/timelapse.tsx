      ...
      >
        ...
        {selected && selected.species === "몬스테라" && generating && (
          <View style={styles.centerFill}>
            {/* timelapseDecoBox */}
            <View
              style={[styles.timelapseDecoBox, { borderColor: theme.border }]}
            >
              <Image
            ...
            <Text style={[styles.loadingSub, { color: theme.text }]}>
              생성된 타임랩스 보여주기
            </Text>
          </View>
        )}
